...
class PositionCreateForm extends Component
{
    ...
    public function savePositions()
    {
        ...
        ], ['positions.0.name.required' => 'Setidaknya input Divisi / Jurusan pertama wajib diisi.']);
        ...
        redirect()->route('positions.index')->with('success', 'Data Divisi / Jurusan berhasil ditambahkan.');
    }
